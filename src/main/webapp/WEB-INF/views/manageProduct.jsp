		...
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/addProduct" 
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:select path="categoryId" items="${categories}" itemLabel="categoryName" itemValue="id" class="form-control"/>
